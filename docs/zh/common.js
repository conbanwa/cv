...
const projects = [
  {
    ...
    affiliated: '跨项目专项',
    description: `
    背景：多团队维护的高频迭代项目安全风险频发（外部输入漏洞、内存泄漏等），代码质量参差不齐，导致产品性能、可靠性下降30%。
    <br />
    职责：搭建全维度代码质量治理体系，实现安全校验自动化、代码提交规范化，最小化维护过程中的副作用。
    <br />
    1. 设计并落地基于正则的全局代码扫描工具，对全代码库的外部输入、内存管理、异常恢复、敏感数据及IO安全进行全量排查校验；
    <br />
    2. 针对高频维护项目搭建定制化质量拦截系统，开发自动化测试脚本替代手工自测，覆盖90%核心业务场景；
    <br />
  ...
  },
  {
    ...
    affiliated: '华为',
    description: `
    背景：Open Harmony Next移动端App快速迭代过程中测试效率低、质量不稳定，25%的bug仅在生产环境被发现。
    <br />
    职责：搭建测试驱动开发（TDD）体系与自动化测试流水线，提升测试效率与产品稳定性。
    <br />
    1. 为移动端App设计并搭建完整的TDD体系，涵盖自测试模块开发及全版本自动化测试流水线构建；
    <br />
    2. 在自动化测试阶段全程监控质量、性能、稳定性核心指标，确保交付标准落地；
    <br />
    3. 基于Jenkins和CI/CD流水线优化测试流程，集成自动化安全扫描与性能测试；
    <br />
  ...
  },
  {
    ...
    affiliated: 'Bybit',
    description: `
    背景：现有中心化衍生品交易所存在扩展性不足、安全风险高等问题，需搭建去中心化非托管解决方案，支持任意代币对的永续掉期交易市场。
    <br />
    职责：开发去中心化衍生品交易所高性能后端系统，保障交易处理的精准性与稳定性。
    <br />
    1. 开发去中心化非托管衍生品协议，支持任意代币对的永续掉期交易市场搭建；
    <br />
    2. 实现去中心化衍生品市场的高精准、高性能交易处理逻辑，支撑1万+ TPS交易并发；
    <br />
    3. 采集智能合约数据并构建GraphQL接口供服务端及前端调用，将数据查询速度优化40%；
    <br />
  ...
  },
  {
    ...
    affiliated: 'Bybit',
    description: `
    背景：DeFi平台用户参与度低，需搭建交易挖矿机制提升用户持仓量与平台流动性。
    <br />
    职责：设计并实现交易挖矿活动后端，优化奖励计算逻辑提升活动效果。
    <br />
    1. 设计并实现交易挖矿活动后端，提升用户持仓量参与率；
    <br />
    2. 基于用户行为分析开发奖励计算逻辑，将活动转化率提升35%；
    <br />
    3. 采用Go语言构建核心框架，对接以太坊智能合约，基于Redis和MySQL管理活动数据并保障数据一致性；
    <br />
    4. 集成去中心化交易所（DEX）协议与以太坊区块链上的不可变智能合约，保障交易安全。
    <br />
    成果：平台流动性提升50%，用户持仓量增长45%，日均处理10万+笔交易挖矿订单，实现0数据丢失。
    <br />`,
  },
  {
    cls: 'erp',
    ...
    time: '2016/9 ~ 2017/9',
    description: `
    背景：企业管理层缺乏资源可视化管理工具，导致运营效率低，各部门数据碎片化。
    <br />
    职责：搭建全维度CMS & ERP平台，实现企业资源可视化与业务流程标准化。
    <br />
    1. 基于Gin+MySQL构建企业资源可视化CMS系统，支持实时数据监控与决策分析；
    <br />
    2. 开发ERP核心模块，涵盖物料清单（BOM）、生产管控、订单处理、角色权限管理等；
    <br />
    3. 优化数据库结构，支撑日均100万+数据条目处理，查询时间减少50%；
    <br />
    4. 基于Vue.js和Node.js集成前后端系统，将系统响应速度提升30%。
    <br />
    成果：企业运营效率提升40%，手工录单错误率降低80%，统一5+部门数据管理，支撑500+并发用户访问。
    <br />`,
  },
];
const works = [
